...
class CrewsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create crew" do
    assert_difference("Crew.count") do
      post crews_url, params: { crew: { email: @crew.email, group_id: @crew.group_id, name: @crew.name, phone: @crew.phone } }
    end
  ...
  test "should update crew" do
    patch crew_url(@crew), params: { crew: { email: @crew.email, group_id: @crew.group_id, name: @crew.name, phone: @crew.phone } }
